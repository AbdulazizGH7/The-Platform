...
//     // Correcting the delete request to pass the proper feedbackId and instructorId
//     axios
//       .delete(`http://localhost:8080/api/instructors/${instructorId}/deleteFeedback`, {
//         data: { feedbackId },  // Sending feedbackId as part of the request body
//       })
//       .then(() => {
...
const FeedbackItem = ({ metrics, review, feedbackId, instructorId, onDelete }) => {
  ...
  const handleConfirmDelete = () => {
    ...
    // Corrected delete request with instructorId and feedbackId
    onDelete(feedbackId, instructorId);  // Pass both IDs to onDelete
    setIsDeleteModalOpen(false); // Close the modal after delete
    setError(null); // Reset any previous error message
  };
